...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let CoolantService = {description: "COOLANT FLUSH", price: ["all", [189]]}
    ...
    let NinetySixKM = {tag: "96KM", services: [BrakeMaintenance, BrakeFluidService, Alignment, BatteryService, AWDService, OilChange, TireRotaion, TransmissionService]}
