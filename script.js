...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let Alignment = {description: "ALIGNMENT CHECK", price: ["all", [193]]}
    let BrakeFluidService = {description: "BRAKE FLUID SERVICE", price: ["all", [135]]}
    let BatteryService = {description: "BATTERY SERVICE", price: ["all", [39]]}
    let BrakeMaintenance = {description: "BRAKE MAINTENANCE", price: ["all", [153]]}
    ...
    let TransmissionService = {description: "TRANSMISSION SERVICE", price: ["options", [375,375,375,375,506,375,272,375,375,375,375,736,468]]}
