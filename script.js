...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let OilChange = {description: "OIL CHANGE", price: ["all", [136]]}
    let TireRotaion = {description: "TIRE ROTATION", price: ["all", [59]]}
    let MajorFuelService = {description: "MAJOR FUEL SERVICE", price: ["all", [275]]}
    let Alignment = {description: "ALIGNMENT(only if needed)", price: ["all", [197]]}
    let BrakeFluidService = {description: "BRAKE FLUID SERVICE", price: ["all", [174]]}
    ...
    let AWDService = {description: 'AWD SERVICE', price: ['options', ['N/A', ap+21, ap+187, ap+21, ap+21, 'N/A', 'N/A', 'N/A', ap+20, 'N/A','N/A', ap+40, ap+40, 350, 480]]}
    ...
    let NinetySixKM = {tag: "96KM", services: [BrakeMaintenance, BrakeFluidService, MajorFuelService, BatteryService, AWDService, Alignment, OilChange, TireRotaion, TransmissionService]}
    ...
    let OneNinetyTwoKM = {tag: "192KM", services: [BrakeMaintenance, BrakeFluidService, MajorFuelService, BatteryService, AWDService, Alignment, OilChange, TireRotaion, TransmissionService]}
        ...
        for (let i = 0; i < services.length; i++) {
            ...
            switch (element.description) {
                ...
                case "BRAKE FLUID SERVICE":
                  ...
                  break;
                case "MAJOR FUEL SERVICE":
                    td3.innerText = "¢"+parseInt(275/24*10)+"/100km"
                   break;
                case "AWD SERVICE":
                    td3.innerText = "¢"+parseInt(td2.innerText.replace("$",'')/24*10)+"/100km"
                    console.log(td2.innerText.slice(0))
                   break;
                case "TRANSMISSION SERVICE":
                    td3.innerText = "¢"+parseInt(td2.innerText.replace("$",'')/24*10)+"/100km"
                    break;
                case "ALIGNMENT(only if needed)":
